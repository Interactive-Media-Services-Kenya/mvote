...
<template>
    ...
    <div class="min-h-screen bg-brand-black flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-brand-black/60 z-10 backdrop-blur-[2px]"></div>
        ...
        <div class="mb-12 text-center animate-fade-up relative z-10">
            <img :src="'/assets/star-yako-logo.png'" alt="Star Yako Logo"
                class="h-20 w-auto mx-auto object-contain drop-shadow-2xl mb-4" />
            <p class="text-gray-200 mt-2 font-black uppercase tracking-[0.3em] text-[10px] drop-shadow-lg">
        ...
        <div class="w-full max-w-sm relative z-10">
            <Transition name="fade-slide" mode="out-in">
                <div v-if="step === 'IDENTIFY'" key="identify" class="space-y-8 animate-fade-up">
                    <div class="space-y-4">
                        <div class="group">
                            <label
                            ...
                            <input v-model="form.phone" @input="form.clearErrors('phone')" type="tel"
                                ...
                                :class="{
                                    'border-red-500/50 bg-red-500/5': form.errors.phone,
                                }" />
                        ...
                        <div class="group">
                            <label
                                class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 transition-colors group-focus-within:text-brand-yellow">
                                Nickname
                                <span class="text-[10px] opacity-50 font-normal">(Optional)</span>
                            </label>
                            <input v-model="form.nick_name" type="text" placeholder=""
                    ...
                    <button @click="handleIdentify" :disabled="!form.phone || form.processing"
                    ...
                    <p class="text-center text-xs text-gray-600 px-4">
                        By continuing, you agree to experience the hype and vote fairly.
                    </p>
                </div>
                ...
                <div v-else key="otp" class="space-y-8 animate-fade-up">
                    <div class="text-center">
                        ...
                        <p class="text-gray-400 text-sm mt-1">
                            Sent code to <span class="text-white">{{ form.phone }}</span>
                        </p>
                    </div>
                    ...
                    <div class="flex justify-between gap-2">
                        <input v-for="(digit, i) in 5" :key="i" v-model="form.otp[i]" type="text" maxlength="1"
                            ...
                            :class="{
                                'border-red-500/50 bg-red-500/5': form.errors.otp,
                            }" @input="handleOtpInput(i, $event)" />
                    </div>
                    <p v-if="form.errors.otp"
            ...
            <Transition name="fade-up">
                <div v-if="showCookieConsent"
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-2xl bg-brand-yellow/10 flex items-center justify-center text-brand-yellow shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
                        <div>
                            <h3 class="font-bold text-white">We Value Your Hype</h3>
                            <p class="text-gray-400 text-xs">We use cookies to enhance your arena experience and analyze site traffic.</p>
                        </div>
                    </div>
...
/* Background Ken Burns Animation */
@keyframes ken-burns {
